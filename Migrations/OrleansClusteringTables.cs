...
[UsedImplicitly]
public class OrleansClusteringTables : IMigrationGroup
{
    public IEnumerable<Migration> Migrations()
    {
        ...
        // заметка: в оригинальном скрипте из документации процедура объявляется
        // с использованием ключечевого слова DELIMITER //
        // MySQLConnector его не поддерживает
        // поэтому я вынес объявление процедуры в отдельную миграцию
        ...
        yield return new Migration(2024_11_14_15_00, sql, "orleans clustering tables pt1");
        ...
        yield return new Migration(2024_11_14_16_00, sql, "orleans clustering tables pt2");
        
        // https://github.com/dotnet/orleans/blob/97f71b547c44c9853ff6f1e0c16b7da259940135/src/AdoNet/Orleans.Clustering.AdoNet/Migrations/MySQL-Clustering-3.7.0.sql
        sql = """
              INSERT INTO OrleansQuery(QueryKey, QueryText)
              VALUES
              (
        ...
        yield return new Migration(2024_11_14_17_00, sql, "orleans clustering tables pt3");
    }
}